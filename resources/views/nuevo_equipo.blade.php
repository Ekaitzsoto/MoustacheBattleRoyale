...
<div class="card text-bg-dark row col-12 col-sm-8 col-md-6 col-lg-4 text-center mt-2">
    <h1 class="fw-bold text-info text-uppercase">Nuevo Equipo</h1>
    <form method="POST" action="{{config('app.url')}}/equipo/nuevo">
        ...
        <div class="row justify-content-center text-start">
            <div class="col-12 mb-3">
                ...
                <input type="text" class="form-control bg-transparent text-light @error('presidente') is-invalid @enderror" id="presidente" name="presidente" value="{{ old('presidente') }}">
            </div>
        </div>

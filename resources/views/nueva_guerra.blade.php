    ...
    <form method="POST" action="{{config('app.url')}}/guerra/nueva">
        ...
        <div class="row justify-content-center text-start">
            <div class="col-12 mb-3">
                ...
                <input type="number" class="form-control bg-transparent text-light @error('jugadores_equipo') is-invalid @enderror" id="jugadores_equipo" name="jugadores_equipo" value="{{ old('jugadores_equipo') }}">
            </div>
        </div>
